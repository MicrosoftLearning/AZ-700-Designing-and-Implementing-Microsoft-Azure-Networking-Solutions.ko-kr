...
1. **규칙 이름** 상자에 RoutingRule**을 입력**합니다.
...
1. Cloud Shell 창의 도구 모음에서 파일 업로드/다운로드** 아이콘을 선택하고 **드롭다운 메뉴에서 **다음 파일 백 엔드.json 및 **backend.parameters.json**** 을 **원본 폴더 **F:\Allfiles\Exercises\M05**에서 하나씩 Cloud Shell 홈 디렉터리에 업로드**합니다.

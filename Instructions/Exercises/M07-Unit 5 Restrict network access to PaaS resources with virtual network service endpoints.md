...
1. 다음 그림과 같이 **백업 사용**을 선택 취소합니다. ![그래픽 사용자 인터페이스, 애플리케이션 자동 생성된 설명](../media/new-file-share-backup.png)
1. **검토 + 만들기**를 선택합니다. 리소스의 유효성을 검사한후 **만들기**를 선택합니다.
...
1. Cloud Shell 창의 도구 모음에서 **파일 업로드/다운로드** 아이콘을 선택하고, 드롭다운 메뉴에서 **업로드**를 선택한 다음, **VMs.json** 및 **VMs.parameters.json** 파일을 소스 폴더 **F:\Allfiles\Exercises\M07**의 Cloud Shell 홈 디렉터리에 차례대로 업로드합니다.

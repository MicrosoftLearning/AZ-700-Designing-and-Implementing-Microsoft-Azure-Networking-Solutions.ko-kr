...
8. **IP 주소** 탭의 **IPv4 주소 공간** 상자에서 기본값을 제거하고 **10.1.0.0/16**을 입력합니다.

9. **IP 주소** 탭에서 **+ 서브넷 추가**를 선택합니다.

10. **서브넷 추가** 창에 **myBackendSubnet**의 서브넷 이름과 **10.1.0.0/24** 서브넷 주소 범위를 입력합니다. **추가** 선택

11. **서브넷 추가**를 다시 선택한 후, 서브넷 이름으로 **myFrontEndSubnet**을 입력하고, 서브넷 주소 범위로는 **10.1.2.0/24**를 지정합니다. **추가** 선택

12. Azure Bastion에 대한 알림에서 **Azure Bastion 서브넷 추가**를 선택합니다.

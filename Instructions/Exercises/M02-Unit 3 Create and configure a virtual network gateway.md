...
## <a name="task-2-create-coreservicesvm"></a>작업 2: CoreServicesVM 만들기
...
## <a name="task-3-create-manufacturingvm"></a>작업 3: ManufacturingVM 만들기
...
3. 테스트 연결이 실패하면 다음과 유사한 결과가 표시됩니다.
...
3. 테스트 연결이 성공하면 다음과 유사한 결과가 표시됩니다.

   ![Test-NetConnection가 성공했습니다.](../media/test-connection-succeeded.png)

4. 원격 데스크톱 연결 창을 닫습니다.
